...
CREATE TABLE IF NOT EXISTS approval_requests (id TEXT PRIMARY KEY, run_id TEXT NOT NULL, issue_id TEXT NOT NULL, kind TEXT NOT NULL, status TEXT NOT NULL, request_json TEXT NOT NULL, decision_json TEXT, reason TEXT, timeout_ms INTEGER, expires_at TEXT, created_at TEXT NOT NULL, resolved_at TEXT);
